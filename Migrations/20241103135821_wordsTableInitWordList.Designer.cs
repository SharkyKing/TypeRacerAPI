...
namespace TypeRacerAPI.Migrations
{
    ...
    [Migration("20241103135821_wordsTableInitWordList")]
    partial class wordsTableInitWordList
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TypeRacerAPI.BaseClasses.WordsBase", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            GameLevelId = 1,
                            Words = "She goes to the zoo. She sees a lion. The lion roars. She sees an elephant. The elephant has a long trunk. She sees a turtle. The turtle is slow. She sees a rabbit. The rabbit has soft fur. She sees a gorilla. The gorilla is eating a banana."
                        },
                        new
                        {
                            Id = 2,
                            GameLevelId = 1,
                            Words = "She sits in the car. Her dad turns on the radio. A song plays. She taps her feet. She sways her head. Her dad laughs at her. He likes the song too. The song is over. The radio plays a different song. She does not like the new song. She sits quietly."
                        },
                        new
                        {
                            Id = 3,
                            GameLevelId = 1,
                            Words = "Today is Father's Day. Daniel surprises his father. He serves him breakfast. There are eggs, bacon, and orange juice on the tray. Daniel's father is happy. Later, they go to play tennis. Daniel stands on one side. He swings the ball. Daniel's father hits the ball back. Finally, they watch the sunset. What a great day!"
                        },
                        new
                        {
                            Id = 4,
                            GameLevelId = 1,
                            Words = "She eats a slice of cake. She drops a crumb. The ants can smell it. They crawl towards the crumb. She notices the ants. She does not want to kill them. She gets a cup. She puts the ants inside. She opens the window. She lets the ants go."
                        },
                        new
                        {
                            Id = 5,
                            GameLevelId = 1,
                            Words = "He goes to the petting zoo. There are many different animals. He pets the turtles. The turtles feel rough. He pets the sheep. The sheep feel wooly. He pets the cows. The cows feel smooth. He pets the bunnies. The bunnies feel fluffy. He tells his mom he wants a pet. His mom says he can get one tomorrow."
                        },
                        new
                        {
                            Id = 6,
                            GameLevelId = 2,
                            Words = "In the resplendent glow of the cerulean twilight, she contemplated the ephemeral nature of existence. The ineffable beauty of the cosmos seemed to whisper secrets of the ancients, urging her to embrace the serendipity that life bestowed. Each star, a scintilla of hope, beckoned her toward the infinitesimal mysteries that lay beyond the horizon of her understanding."
                        },
                        new
                        {
                            Id = 7,
